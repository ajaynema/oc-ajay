...
class state(PybindBase):
  ...
  from YANG module openconfig-platform - based on the path /components/component/integrated-circuit/pipeline-counters/errors/host-interface-block/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Errors corresponding to the host interface subsystem of the IC.
  """
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['components', 'component', 'integrated-circuit', 'pipeline-counters', 'errors', 'host-interface-block', 'state']

  def _get_error_name(self):
    """
    Getter method for error_name, mapped from YANG variable /components/component/integrated_circuit/pipeline_counters/errors/host_interface_block/state/error_name (string)
  ...
  def _set_error_name(self, v, load=False):
    """
    Setter method for error_name, mapped from YANG variable /components/component/integrated_circuit/pipeline_counters/errors/host_interface_block/state/error_name (string)
  ...
  def _get_error_count(self):
    """
    Getter method for error_count, mapped from YANG variable /components/component/integrated_circuit/pipeline_counters/errors/host_interface_block/state/error_count (uint64)
  ...
  def _set_error_count(self, v, load=False):
    """
    Setter method for error_count, mapped from YANG variable /components/component/integrated_circuit/pipeline_counters/errors/host_interface_block/state/error_count (uint64)
    If this variable is read-only (config: false) in the
  ...
  def _get_error_threshold(self):
    """
    Getter method for error_threshold, mapped from YANG variable /components/component/integrated_circuit/pipeline_counters/errors/host_interface_block/state/error_threshold (uint64)
  ...
  def _set_error_threshold(self, v, load=False):
    """
    Setter method for error_threshold, mapped from YANG variable /components/component/integrated_circuit/pipeline_counters/errors/host_interface_block/state/error_threshold (uint64)
    If this variable is read-only (config: false) in the
  ...
  def _get_error_action(self):
    """
    Getter method for error_action, mapped from YANG variable /components/component/integrated_circuit/pipeline_counters/errors/host_interface_block/state/error_action (enumeration)
...
reset, NPU offline, gather diagnostic data, raise an alarm.
  ...
  def _set_error_action(self, v, load=False):
    """
    Setter method for error_action, mapped from YANG variable /components/component/integrated_circuit/pipeline_counters/errors/host_interface_block/state/error_action (enumeration)
    If this variable is read-only (config: false) in the
...
reset, NPU offline, gather diagnostic data, raise an alarm.
  ...
  def _get_error_level(self):
    """
    Getter method for error_level, mapped from YANG variable /components/component/integrated_circuit/pipeline_counters/errors/host_interface_block/state/error_level (enumeration)
...
Informational.
  ...
  def _set_error_level(self, v, load=False):
    """
    Setter method for error_level, mapped from YANG variable /components/component/integrated_circuit/pipeline_counters/errors/host_interface_block/state/error_level (enumeration)
    If this variable is read-only (config: false) in the
