...
class network_instance(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__name','__fdb','__config','__state','__evpn','__encapsulation','__inter_instance_policies','__table_connections','__interfaces','__route_limits','__tables','__connection_points','__mpls','__segment_routing','__vlans','__policy_forwarding','__afts','__protocols',)
