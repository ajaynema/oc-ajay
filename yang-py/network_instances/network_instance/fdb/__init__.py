...
the forwarding database of the network instance
  """
  __slots__ = ('_path_helper', '_extmethods', '__config','__state','__mac_table','__mac_mobility',)
...
mobility.
  ...
  _pyangbind_elements = OrderedDict([('config', config), ('state', state), ('mac_table', mac_table), ('mac_mobility', mac_mobility), ])
