...
with the configured anycast MAC address.
  ...
  def _get_arp_proxy(self):
    """
    Getter method for arp_proxy, mapped from YANG variable /network_instances/network_instance/fdb/config/arp_proxy (boolean)
...
IP address that is not on that network.
  ...
  def _set_arp_proxy(self, v, load=False):
    """
    Setter method for arp_proxy, mapped from YANG variable /network_instances/network_instance/fdb/config/arp_proxy (boolean)
    If this variable is read-only (config: false) in the
...
IP address that is not on that network.
  ...
  def _get_arp_suppression(self):
    """
    Getter method for arp_suppression, mapped from YANG variable /network_instances/network_instance/fdb/config/arp_suppression (boolean)
...
VMs connected to the same logical switch.
  ...
  def _set_arp_suppression(self, v, load=False):
    """
    Setter method for arp_suppression, mapped from YANG variable /network_instances/network_instance/fdb/config/arp_suppression (boolean)
    If this variable is read-only (config: false) in the
...
VMs connected to the same logical switch.
  ...
  def _get_nd_proxy(self):
    """
    Getter method for nd_proxy, mapped from YANG variable /network_instances/network_instance/fdb/config/nd_proxy (boolean)
...
NDP packets for an IP address that is not on that network.
  ...
  def _set_nd_proxy(self, v, load=False):
    """
    Setter method for nd_proxy, mapped from YANG variable /network_instances/network_instance/fdb/config/nd_proxy (boolean)
    If this variable is read-only (config: false) in the
...
NDP packets for an IP address that is not on that network.
  ...
  def _get_nd_suppression(self):
    """
    Getter method for nd_suppression, mapped from YANG variable /network_instances/network_instance/fdb/config/nd_suppression (boolean)
...
VMs connected to the same logical switch.
  ...
  def _set_nd_suppression(self, v, load=False):
    """
    Setter method for nd_suppression, mapped from YANG variable /network_instances/network_instance/fdb/config/nd_suppression (boolean)
    If this variable is read-only (config: false) in the
