...
class interface(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__interface_id','__config','__state','__circuit_counters','__authentication','__afi_safi','__levels','__timers','__enable_bfd','__bfd','__mpls','__interface_ref',)
...
features in IS-IS
  ...
  _pyangbind_elements = OrderedDict([('interface_id', interface_id), ('config', config), ('state', state), ('circuit_counters', circuit_counters), ('authentication', authentication), ('afi_safi', afi_safi), ('levels', levels), ('timers', timers), ('enable_bfd', enable_bfd), ('bfd', bfd), ('mpls', mpls), ('interface_ref', interface_ref), ])
