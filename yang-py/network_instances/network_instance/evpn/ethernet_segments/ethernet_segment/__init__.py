...
class ethernet_segment(PybindBase):
  ...
  def _get_df_election(self):
    """
    Getter method for df_election, mapped from YANG variable /network_instances/network_instance/evpn/ethernet_segments/ethernet_segment/df_election (container)
...
for the Designated forwarding Election
  ...
  def _set_df_election(self, v, load=False):
    """
    Setter method for df_election, mapped from YANG variable /network_instances/network_instance/evpn/ethernet_segments/ethernet_segment/df_election (container)
    If this variable is read-only (config: false) in the
...
class ethernet_segment(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/evpn/ethernet-segments/ethernet-segment. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
