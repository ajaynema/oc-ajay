...
operational state data
  """
  __slots__ = ('_path_helper', '_extmethods', '__config','__state','__clock','__dns','__ntp','__ssh_server','__telnet_server','__logging','__aaa','__memory','__cpus','__processes','__alarms','__messages','__license',)
...
system
  ...
  _pyangbind_elements = OrderedDict([('config', config), ('state', state), ('clock', clock), ('dns', dns), ('ntp', ntp), ('ssh_server', ssh_server), ('telnet_server', telnet_server), ('logging', logging), ('aaa', aaa), ('memory', memory), ('cpus', cpus), ('processes', processes), ('alarms', alarms), ('messages', messages), ('license', license), ])
