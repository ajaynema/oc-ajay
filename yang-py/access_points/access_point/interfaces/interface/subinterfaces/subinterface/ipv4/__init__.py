...
class ipv4(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__addresses','__proxy_arp','__neighbors','__config','__state',)
...
explicitly destined to the local system.
  ...
  _pyangbind_elements = OrderedDict([('addresses', addresses), ('proxy_arp', proxy_arp), ('neighbors', neighbors), ('config', config), ('state', state), ])
