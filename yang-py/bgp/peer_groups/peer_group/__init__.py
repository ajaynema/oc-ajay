...
thegroup
  ...
  def _get_enable_bfd(self):
    """
    Getter method for enable_bfd, mapped from YANG variable /bgp/peer_groups/peer_group/enable_bfd (container)
...
neighbour.
  ...
  def _set_enable_bfd(self, v, load=False):
    """
    Setter method for enable_bfd, mapped from YANG variable /bgp/peer_groups/peer_group/enable_bfd (container)
    If this variable is read-only (config: false) in the
