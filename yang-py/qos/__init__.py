...
class qos(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__interfaces','__classifiers','__forwarding_groups','__queues','__scheduler_policies',)
  ...
  _pyangbind_elements = OrderedDict([('interfaces', interfaces), ('classifiers', classifiers), ('forwarding_groups', forwarding_groups), ('queues', queues), ('scheduler_policies', scheduler_policies), ])
