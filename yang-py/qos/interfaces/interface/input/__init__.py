...
interface
  """
  __slots__ = ('_path_helper', '_extmethods', '__classifiers','__queues','__scheduler_policy','__virtual_output_queues',)
...
interface.
  ...
  _pyangbind_elements = OrderedDict([('classifiers', classifiers), ('queues', queues), ('scheduler_policy', scheduler_policy), ('virtual_output_queues', virtual_output_queues), ])
