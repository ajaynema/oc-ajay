...
interface
  ...
  def _get_config(self):
    """
    Getter method for config, mapped from YANG variable /qos/interfaces/interface/input/classifiers/classifier/terms/term/config (container)
...
associated with an interface
  ...
  def _set_config(self, v, load=False):
    """
    Setter method for config, mapped from YANG variable /qos/interfaces/interface/input/classifiers/classifier/terms/term/config (container)
    If this variable is read-only (config: false) in the
