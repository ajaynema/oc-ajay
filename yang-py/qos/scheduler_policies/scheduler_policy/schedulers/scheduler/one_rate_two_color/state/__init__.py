...
class state(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__queuing_behavior = YANGDynClass(base=RestrictedClassType(base_type=six.text_type,                                     restriction_type="dict_key",                                     restriction_arg={'SHAPE': {}, 'POLICE': {}},), is_leaf=True, yang_name="queuing-behavior", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/qos', defining_module='openconfig-qos', yang_type='oc-qos-types:queue-behavior', is_config=False)
...
bucket.
  ...
  def _set_queuing_behavior(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=six.text_type,                                     restriction_type="dict_key",                                     restriction_arg={'SHAPE': {}, 'POLICE': {}},), is_leaf=True, yang_name="queuing-behavior", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/qos', defining_module='openconfig-qos', yang_type='oc-qos-types:queue-behavior', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=six.text_type,                                     restriction_type="dict_key",                                     restriction_arg={'SHAPE': {}, 'POLICE': {}},), is_leaf=True, yang_name="queuing-behavior", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/qos', defining_module='openconfig-qos', yang_type='oc-qos-types:queue-behavior', is_config=False)""",
        })
