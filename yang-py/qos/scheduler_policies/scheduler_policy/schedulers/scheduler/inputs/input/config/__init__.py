...
class config(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__input_type = YANGDynClass(base=RestrictedClassType(base_type=six.text_type,                                     restriction_type="dict_key",                                     restriction_arg={'QUEUE': {}, 'IN_PROFILE': {}, 'OUT_PROFILE': {}},), is_leaf=True, yang_name="input-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/qos', defining_module='openconfig-qos', yang_type='enumeration', is_config=True)
