...
class state(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__async = YANGDynClass(base=async.async, is_container='container', yang_name="async", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/bfd', defining_module='openconfig-bfd', yang_type='container', is_config=False)
...
asynchronous mode of BFD.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=async.async, is_container='container', yang_name="async", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/bfd', defining_module='openconfig-bfd', yang_type='container', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """async must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=async.async, is_container='container', yang_name="async", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/bfd', defining_module='openconfig-bfd', yang_type='container', is_config=False)""",
        })
